          ...
          withKubeConfig([credentialsId: '6ad93d41-e6fc-4462-b6bc-297e360784fd', serverUrl: 'https://api.okd-c1.eclipse.org:6443']) {
            sh '''
              ...
              if [[ $(echo "${DEPLOYMENT}" | jq -r 'length') -eq 0 ]]; then
                ...
                kubectl create configmap eclipsefdn-project-adopters-map --from-file=adopters_json_compressed=config/adopters.json --dry-run=client -o yaml | kubectl apply -f -
